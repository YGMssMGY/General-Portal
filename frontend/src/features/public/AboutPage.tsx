  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 lg:px-6 lg:py-16">
      ...
      <p className="mt-4 text-expressive-01 text-text-secondary max-w-3xl">
        The Developers' Club and Student Council work together to create a vibrant
        community of student leaders and innovators. We organize events, manage
        resources, and represent the student body.
      </p>
      ...
      <div className="mt-12 grid gap-8 md:grid-cols-2">
        <section className="border border-border-subtle bg-surface p-6">
          ...
          <h2 className="mt-4 text-expressive-02 font-semibold text-text-primary">
            Our Mission
          </h2>
          <p className="mt-2 text-productive-02 text-text-secondary">
            To foster a collaborative environment where students can develop
            technical skills, leadership abilities, and meaningful connections
            that last beyond their school years.
          </p>
        </section>
        ...
        <section className="border border-border-subtle bg-surface p-6">
          ...
          <p className="mt-2 text-productive-02 text-text-secondary">
            A school community where every student has the opportunity to
            explore technology, develop as a leader, and contribute to
            meaningful projects.
          </p>
        </section>
      </div>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div key={item.role} className="border-l-2 border-carbon-blue-60 bg-surface p-4">
              <h3 className="text-productive-03 font-semibold text-text-primary">
                {item.role}
              </h3>
      ...
      <section className="mt-16 border-t border-border-subtle pt-12">
        ...
        <p className="mt-4 text-expressive-01 text-text-secondary max-w-2xl">
          We welcome all students regardless of experience level. Whether you
          want to learn to code, organize events, or develop leadership skills,
