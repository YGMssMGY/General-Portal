      ...
      <div style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                ...
                return (
                  <Tile
                    ...
                    style={{
                      ...
                      textAlign: "center",
                      border:
                        selectedFile?.id === file.id ? "2px solid var(--cds-focus)" : undefined,
                    }}
                  >
                    {isImg ? (
                      <div
                      ...
                      >
                        {file.url ? (
                          ...
                          <Image size={28} style={{ color: "var(--cds-text-secondary)" }} />
                        )}
                      </div>
                    ) : (
                      <div
        ...
        {detailFile ? (
          ...
          >
            ...
            >
              <span style={{ fontWeight: 600, fontSize: "0.875rem" }}>File Details</span>
              <Button
                kind="ghost"
                size="sm"
                renderIcon={Close}
              ...
              <Stack gap={5}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "0.875rem", fontWeight: 500 }}>
                      {formatDateTime(detailFile.uploadedAt || detailFile.updatedAt)}
                    </p>
                  </div>
                </div>
                ...
                <Stack gap={3}>
                  <Button
                    ...
                    renderIcon={Download}
                    onClick={() => {
                      window.open(workspaceApi.getFileDownloadUrl(detailFile.id), "_blank");
                    }}
                  >
                    Download
                  </Button>
          ...
          >
            <Stack gap={5}>
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.75rem" }}>
                ...
                >
                  {isUploading ? "Uploading..." : `Upload (${uploadItems.length})`}
                </Button>
              </div>
            </Stack>
          </Form>
        ...
        >
          ...
          >
            ...
            <Button
              ...
              renderIcon={Download}
              onClick={() =>
                window.open(workspaceApi.getFileDownloadUrl(previewImage.id), "_blank")
              }
            >
              Download
            </Button>
