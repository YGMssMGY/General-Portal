        ...
        <Tile style={{ flex: 2, padding: "1.5rem" }}>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} style={{ display: "flex", gap: "1rem", marginTop: "1rem" }}>
              <SkeletonPlaceholder style={{ width: "2rem", height: "2rem", borderRadius: "50%" }} />
              <div style={{ flex: 1 }}>
        ...
        {[1, 2, 3, 4, 5].slice(0, rows).map((i) => (
          <div
            ...
            style={{
              ...
              borderBottom: i < rows ? "1px solid var(--cds-border-subtle)" : undefined,
            }}
          >
  ...
  return (
    <Tile style={{ padding: "1.5rem" }}>
      ...
      <div style={{ marginTop: "1rem" }}>
        <SkeletonPlaceholder style={{ width: "100%", height: "0.5rem", borderRadius: "4px" }} />
      </div>
    </Tile>
  );
}
