							...
							<>
								...
								>
									...
									>
										<span style={{ opacity: 0.7 }}>
											{(() => {
												const Icon =
													contextIcon[selected.context] || Document;
												return <Icon size={20} />;
											})()}
										</span>
										<span
								...
								{selected.context !== "general" ? (
									...
									>
										...
										>
											This conversation is linked to a {selected.context}.
											Messages and updates related to this resource will
											appear here.
										</p>
									</div>
								) : null}
				...
				<Form onSubmit={handleCompose}>
					<div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
						<TextInput
							...
							onChange={(e) =>
								setComposeForm((c) => ({ ...c, title: e.target.value }))
							}
						/>
						<Select
							id="thread-context"
						...
						<TextArea
							...
							onChange={(e) =>
								setComposeForm((c) => ({ ...c, body: e.target.value }))
							}
						/>
						{composeError ? (
							<p
