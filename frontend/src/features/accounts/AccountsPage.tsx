      ...
      <Stack gap={6}>
        ...
        <Tile style={{ padding: "1.5rem" }}>
          ...
          <Stack gap={4}>
            ...
            <div>
              ...
              <ProgressBar value={progressPct} label="Progress to next level" hideLabel />
            </div>
          </Stack>
        </Tile>
        ...
        <Tile style={{ padding: "1.5rem" }}>
          ...
          {lbError ? (
            ...
            <p style={{ fontSize: "0.875rem", color: "var(--cds-text-secondary)" }}>No data yet.</p>
          ) : (
          ...
          {kudos.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              {kudos.slice(0, 10).map((k) => (
                ...
                >
                  <p style={{ fontSize: "0.8125rem", color: "var(--cds-text-primary)" }}>
