                  ...
                  {stats?.tasksCompletedTrend != null ? (
                    ...
                    >
                      {stats.tasksCompletedTrend >= 0 ? (
                        ...
                        <ArrowDown size={16} style={{ color: "var(--cds-support-error)" }} />
                      )}
                      <span
                        style={{
                          fontSize: "0.875rem",
                      ...
                      >
                        {Math.abs(stats.tasksCompletedTrend)}% vs last week
                      </span>
                    </div>
                  ) : null}
                </div>
                <Task size={24} style={{ color: "#0f62fe" }} aria-hidden="true" />
              </div>
            </Tile>
          </Column>
          <Column lg={5} md={4} sm={4} style={{ marginBottom: "1rem" }}>
            <Tile style={{ padding: "1.5rem" }}>
              ...
              >
                ...
                <Warning size={24} style={{ color: "#da1e28" }} aria-hidden="true" />
              </div>
            </Tile>
          </Column>
          <Column lg={6} md={4} sm={4} style={{ marginBottom: "1rem" }}>
            <Tile style={{ padding: "1.5rem" }}>
              ...
              >
                ...
                <Calendar size={24} style={{ color: "#007d79" }} aria-hidden="true" />
              </div>
            </Tile>
          </Column>
        </Row>
            ...
            {(stats?.openTasksByStatus ?? []).length > 0 ? (
              stats!.openTasksByStatus.map((item) => (
                <div key={item.status}>
                  ...
                  >
                    <span style={{ fontSize: "0.875rem", fontWeight: 500 }}>{item.status}</span>
                    <span
                      style={{
                        fontSize: "0.875rem",
                        fontWeight: 600,
        ...
        <Card padding="lg">
          ...
          {(stats?.topContributors ?? []).length > 0 ? (
            <DataTable
              ...
              data={stats!.topContributors as unknown as Record<string, unknown>[]}
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: "0.75rem 0",
                    borderBottom:
                      i < activity.length - 1 ? "1px solid var(--cds-border-subtle)" : "none",
                  }}
                >
                  <div
                    style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <Tag type="outline" style={{ fontSize: "0.6875rem" }}>
                        {item.resourceType}
                      </Tag>
                    </div>
                    <p
